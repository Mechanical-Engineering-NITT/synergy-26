...
export default function AccommodationSection({
	...
	return (
		<div className="min-h-screen bg-black overflow-hidden relative font-sans text-white selection:bg-fuchsia-500/30">
			...
			{/* 2. Retro Sun Section (Consistent with Events/Workshops) */}
			...
			<div className="relative z-30 p-6 max-w-6xl mx-auto py-20">
				...
				<div className="group relative bg-zinc-900/40 backdrop-blur-md border border-white/10 p-10 md:p-16 transition-all duration-300 hover:border-cyan-500/50 hover:shadow-[0_0_30px_rgba(34,211,238,0.15)] overflow-hidden -skew-x-2 min-h-[400px] flex items-center">
					{/* Card Accent */}
					<div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-bl from-cyan-500/10 to-transparent -translate-y-full group-hover:translate-y-0 transition-transform duration-500"></div>

					<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 relative z-10 w-full">
						<div className="grow">
							<h3 className="text-3xl md:text-4xl font-black text-white uppercase italic tracking-wider mb-2 group-hover:text-cyan-400 transition-colors">
								Stay at NITT Campus
							</h3>
							<div className="h-0.5 w-16 bg-amber-400 mb-8 transition-all group-hover:w-full duration-500"></div>
							...
							<div className="flex flex-wrap gap-6">
								<div className="flex items-center gap-4 text-sm md:text-base font-bold uppercase tracking-[0.2em] text-cyan-400/80 bg-cyan-500/10 px-6 py-3 border border-cyan-500/30">
								...
								<div className="flex items-center gap-4 text-sm md:text-base font-bold uppercase tracking-[0.2em] text-amber-400/80 bg-amber-400/10 px-6 py-3 border border-amber-400/30">
							...
							className={`w-full md:w-auto px-12 py-5 font-black uppercase tracking-[0.2em] text-xl transition-all duration-300 -skew-x-12 relative overflow-hidden group/btn shrink-0
								${
									remainingNights <= 0
										...
										: "bg-amber-400 text-black hover:bg-amber-300 shadow-[8px_8px_0px_0px_rgba(34,211,238,1)] hover:translate-x-1 hover:translate-y-1 active:translate-y-2"
								}`}
					...
					<div className="bg-zinc-950 border-2 border-cyan-500/50 shadow-[0_0_50px_rgba(34,211,238,0.2)] max-w-md w-full p-8 animate-in zoom-in-95 duration-300 relative">
						...
						<div className="space-y-6 mb-8">
							<div>
										...
										return (
											<button
												...
												className={`w-14 h-14 border-2 flex items-center justify-center font-black transition-all -skew-x-6
													${
														isSelected
															? "border-cyan-400 bg-cyan-400 text-black shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]"
															: "border-white/10 text-white hover:border-cyan-400/50 hover:bg-white/5"
													}`}
											>
								...
								<p className="mt-4 text-[10px] text-cyan-400/70 font-bold uppercase tracking-wider">
