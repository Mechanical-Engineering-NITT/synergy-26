	...
	return (
		...
		>
			...
			<div className="space-y-3 mb-8 grow">
				<div className="flex items-center gap-3 text-xs font-bold uppercase tracking-widest text-[#FF2E63]">
	...
	return (
		<div className="min-h-screen bg-[#090521] overflow-hidden relative font-sans text-white selection:bg-[#FF2E63]/30">
			...
			<div className="relative z-30 p-6 max-w-6xl mx-auto py-20">
				...
				{!hasEventPass && (
					<div className="relative group bg-[#090521]/60 backdrop-blur-md border-2 border-[#FFDD00] -skew-x-3 p-8 text-white mb-16 shadow-[10px_10px_0px_0px_rgba(157,0,255,0.5)] overflow-hidden hover:shadow-[15px_15px_0px_0px_rgba(255,46,99,0.6)] transition-all">
						...
						<div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
							<div className="text-center md:text-left">
								<h2 className="text-3xl font-black uppercase italic tracking-tighter mb-2 text-[#FF2E63] drop-shadow-[0_0_5px_rgba(255,46,99,0.8)]">
									Event Pass
								</h2>
							...
							<button
								...
								className="group relative px-8 py-4 bg-[#FFDD00] hover:bg-[#FFDD00] text-black font-black text-xl -skew-x-12 shadow-[5px_5px_0px_0px_rgba(157,0,255,1)] hover:shadow-[8px_8px_0px_0px_rgba(255,46,99,1)] transition-all hover:translate-y-1 active:translate-y-2 overflow-hidden w-full md:w-auto"
							>
				...
				{isPassDialogOpen && (
					<div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-in fade-in duration-300">
						<div className="bg-[#090521] border-2 border-[#FF2E63] shadow-[0_0_80px_rgba(255,46,99,0.4)] max-w-md w-full p-8 animate-in zoom-in-95 duration-300 relative">
							{/* Corner Accents */}
							...
							<div className="space-y-4 mb-8">
								{[
									...
									<div key={text} className="flex items-center gap-3 group">
										<div className="w-5 h-5 border border-[#FF2E63] flex items-center justify-center font-bold text-[10px] text-[#FF2E63] group-hover:bg-[#FF2E63] group-hover:text-black transition-colors shadow-[0_0_10px_rgba(255,46,99,0.4)]">
											X
										</div>
							...
							<div className="bg-white/5 border border-white/10 p-5 mb-8 -skew-x-2">
								<div className="flex justify-between items-center bg-[#FF2E63]/10 p-2 border-l-4 border-[#FF2E63]">
